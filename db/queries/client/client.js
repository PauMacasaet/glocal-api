...
module.exports = {
    getAll() {
        return knex('client')
        .select('accountName', knex.raw('contact_details[0:2][2] AS Customer_Name, contact_details[2:2][2] AS Email, contact_details[3:3][3] AS Contact_Number'), 'company_address', 'accountManager');
    },
    getOne(accountName) {
        return knex('client')
        .select('accountName', knex.raw('contact_details[0:2][2] AS Customer_Name, contact_details[2:2][2] AS Email, contact_details[3:3][3] AS Contact_Number'), 'company_address', 'accountManager')
