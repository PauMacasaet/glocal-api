...
module.exports = {
    getAll(query) {
        const knexQuery = knex('client')
            .select(
                'accountName', 
                knex.raw('contact_details[0:2][30] AS Customer_Name, contact_details[2:2][30] AS Email, contact_details[3:3][30] AS Contact_Number, contact_details[4:4][30] as Position'), 
                'company_address', 
                'accountManager'
            )
